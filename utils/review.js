...
export async function createNewReview(db, req) {
	...
	if(query.queryOneToMuch(db, await idReviewCreate, req.query.img_review.split(','), 'img_review', 'id_review', 'id_image')){
...
export async function updateReview(db, req) {
	...
	//// falta meter cosas, me quedo por aquí, estoy hasta la polla
